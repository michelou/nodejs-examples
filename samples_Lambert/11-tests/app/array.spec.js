...
describe('Array', function () {
  ...
  describe('.length', function () {
    ...
    it('can be used to change the size', function () {
      ...
      expect(this.array[0]).to.be.undefined // eslint-disable-line no-unused-expressions
    })
  })
  ...
  describe('[] operator', function () {
    ...
    it('returns undefined for a missing item', function () {
      expect(this.array[99]).to.be.undefined // eslint-disable-line no-unused-expressions
    })
