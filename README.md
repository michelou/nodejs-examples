...
For instance our development environment looks as follows (*June 2024*) <sup id="anchor_02"><a href="#footnote_02">2</a></sup>:
...
C:\opt\node-v18.20.3-win-x64\    <i>( 78 MB)</i>
C:\opt\node-v20.14.0-win-x64\    <i>( 77 MB)</i>
...
Tool versions:
   node v16.20.2, npm 9.8.1, node v18.20.3, npm 10.5.0
   mongod v7.0.9, mongosh 2.2.6,
...
<dd>
<pre style="font-size:80%;">
<a href="https://www.mongodb.com/try/download/community">mongodb-windows-x86_64-7.0.9.zip</a>  <i>(336 MB)</i>
<a href="https://www.mongodb.com/try/download/shell">mongosh-2.2.6-win32-x64.zip</a>       <i>( 33 MB)</i>
...
<a href="https://nodejs.org/dist/latest-v20.x/">node-v20.14.0-win-x64.zip</a>         <i>( 28 MB)</i>
...
[nodejs20_changelog]: https://github.com/nodejs/node/blob/master/doc/changelogs/CHANGELOG_V20.md#20.14.0
